...
class CloudIntegrationGcpBilling(pulumi.CustomResource):
    ...
    """
    def __init__(__self__, resource_name, opts=None, additional_tags=None, api_key=None, force_save=None, json_key=None, name=None, project_id=None, service=None, service_refresh_rate_in_minutes=None, __props__=None, __name__=None, __opts__=None):
        """
    ...
    @staticmethod
    def get(resource_name, id, opts=None, additional_tags=None, api_key=None, force_save=None, json_key=None, name=None, project_id=None, service=None, service_refresh_rate_in_minutes=None):
        """
