...
class CloudIntegrationGcpBillingArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] api_key: API key for Google Cloud Platform (GCP).
...
@pulumi.type_token("wavefront:index/cloudIntegrationGcpBilling:CloudIntegrationGcpBilling")
class CloudIntegrationGcpBilling(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            project_id: Optional[pulumi.Input[_builtins.str]] = None,
            service: Optional[pulumi.Input[_builtins.str]] = None,
            service_refresh_rate_in_minutes: Optional[pulumi.Input[_builtins.int]] = None) -> 'CloudIntegrationGcpBilling':
        """
