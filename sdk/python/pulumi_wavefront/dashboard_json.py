...
class DashboardJsonArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] dashboard_json: See the [Wavefront API Documentation](https://docs.wavefront.com/wavefront_api.html#api-documentation-wavefront-instance)
...
class _DashboardJsonState:
    def __init__(__self__, *,
                 dashboard_json: Optional[pulumi.Input[_builtins.str]] = None):
        """
...
@pulumi.type_token("wavefront:index/dashboardJson:DashboardJson")
class DashboardJson(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None,
            dashboard_json: Optional[pulumi.Input[_builtins.str]] = None) -> 'DashboardJson':
        """
