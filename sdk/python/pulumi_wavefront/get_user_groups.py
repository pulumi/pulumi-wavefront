...
class GetUserGroupsResult:
    ...
    """
    def __init__(__self__, id=None, limit=None, offset=None, user_groups=None):
...
def get_user_groups(limit: Optional[_builtins.int] = None,
...
def get_user_groups_output(limit: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
