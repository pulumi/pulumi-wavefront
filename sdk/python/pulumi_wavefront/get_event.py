...
def get_event(id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str id: The ID associated with the event data to be fetched.
    """
    __args__ = dict()
    __args__['id'] = id
...
def get_event_output(id: Optional[pulumi.Input[_builtins.str]] = None,
