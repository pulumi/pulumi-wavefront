...
class CloudIntegrationEc2Args:
    def __init__(__self__, *,
                 ...
                 hostname_tags: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] hostname_tags: A list of AWS instance tags to use as the `source` name
    ...
    def hostname_tags(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]:
        """
    ...
    def hostname_tags(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]):
...
class CloudIntegrationEc2(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            role_arn: Optional[pulumi.Input[_builtins.str]] = None,
            service: Optional[pulumi.Input[_builtins.str]] = None,
            service_refresh_rate_in_minutes: Optional[pulumi.Input[_builtins.int]] = None) -> 'CloudIntegrationEc2':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="hostnameTags")
    def hostname_tags(self) -> pulumi.Output[Optional[Sequence[_builtins.str]]]:
        """
        A list of AWS instance tags to use as the `source` name
        in a series. Default is `["hostname", "host", "name"]`. If no tag in the list is found, the series source
        is set to the instance id.
