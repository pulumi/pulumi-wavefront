...
class _MetricsPolicyState:
    def __init__(__self__, *,
                 ...
                 updated_epoch_millis: Optional[pulumi.Input[_builtins.int]] = None,
        ...
        :param pulumi.Input[_builtins.str] customer: The customer the user is associated with.
        :param pulumi.Input[Sequence[pulumi.Input['MetricsPolicyPolicyRuleArgs']]] policy_rules: List of Metrics Policies, must have at least one entry.
        :param pulumi.Input[_builtins.int] updated_epoch_millis: When the policy was applied in epoch_millis.
        :param pulumi.Input[_builtins.str] updater_id: The account_id who applied the current policy.
        """
    ...
    def updated_epoch_millis(self) -> Optional[pulumi.Input[_builtins.int]]:
        """
    ...
    def updated_epoch_millis(self, value: Optional[pulumi.Input[_builtins.int]]):
...
class MetricsPolicy(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            policy_rules: Optional[pulumi.Input[Sequence[pulumi.Input[Union['MetricsPolicyPolicyRuleArgs', 'MetricsPolicyPolicyRuleArgsDict']]]]] = None,
            updated_epoch_millis: Optional[pulumi.Input[_builtins.int]] = None,
            updater_id: Optional[pulumi.Input[_builtins.str]] = None) -> 'MetricsPolicy':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="updatedEpochMillis")
    def updated_epoch_millis(self) -> pulumi.Output[_builtins.int]:
        """
        When the policy was applied in epoch_millis.
        """
        return pulumi.get(self, "updated_epoch_millis")
