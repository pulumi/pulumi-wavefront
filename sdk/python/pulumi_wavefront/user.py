...
class UserArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] email: The unique identifier of the user account to create. Must be a valid email address.
        :param pulumi.Input[builtins.str] customer: The customer the user is associated with.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] permissions: List of permission to grant to this user. Valid options are
               `agent_management`, `alerts_management`, `dashboard_management`, `embedded_charts`, `events_management`, `external_links_management`,
               `host_tag_management`, `metrics_management`, and `user_management`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] user_groups: List of user groups to this user.
        """
