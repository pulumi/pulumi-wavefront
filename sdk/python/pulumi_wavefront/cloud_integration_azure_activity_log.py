...
class CloudIntegrationAzureActivityLogArgs:
    def __init__(__self__, *,
        ...
        """
        CloudIntegrationAzureActivityLogArgs._configure(
...
class _CloudIntegrationAzureActivityLogState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] tenant: Tenant ID for an Azure service account within your project.
        """
        _CloudIntegrationAzureActivityLogState._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            additional_tags=additional_tags,
            category_filters=category_filters,
            client_id=client_id,
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            CloudIntegrationAzureActivityLogArgs._configure(_setter, **kwargs)
