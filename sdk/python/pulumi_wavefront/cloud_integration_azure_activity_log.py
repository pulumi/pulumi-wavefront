...
class CloudIntegrationAzureActivityLogArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] category_filters: A list of Azure services (such as Microsoft.Compute/virtualMachines) from which to pull metrics.
...
class CloudIntegrationAzureActivityLog(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            service: Optional[pulumi.Input[_builtins.str]] = None,
            service_refresh_rate_in_minutes: Optional[pulumi.Input[_builtins.int]] = None,
            tenant: Optional[pulumi.Input[_builtins.str]] = None) -> 'CloudIntegrationAzureActivityLog':
        """
