...
class CloudIntegrationAzureActivityLog(pulumi.CustomResource):
    ...
    """
    def __init__(__self__, resource_name, opts=None, additional_tags=None, category_filters=None, client_id=None, client_secret=None, force_save=None, name=None, service=None, service_refresh_rate_in_minutes=None, tenant=None, __props__=None, __name__=None, __opts__=None):
        """
        ...
        :param pulumi.Input[list] category_filters: A list of Azure services (such as Microsoft.Compute/virtualMachines) from which to pull metrics
    ...
    @staticmethod
    def get(resource_name, id, opts=None, additional_tags=None, category_filters=None, client_id=None, client_secret=None, force_save=None, name=None, service=None, service_refresh_rate_in_minutes=None, tenant=None):
        """
