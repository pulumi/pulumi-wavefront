...
class CloudIntegrationGcp(pulumi.CustomResource):
    ...
    """
    def __init__(__self__, resource_name, opts=None, additional_tags=None, categories=None, force_save=None, json_key=None, metric_filter_regex=None, name=None, project_id=None, service=None, service_refresh_rate_in_minutes=None, __props__=None, __name__=None, __opts__=None):
        """
        ...
        :param pulumi.Input[list] categories: A list of Google Cloud Platform (GCP) services.  Valid values are `APPENGINE`, 
               `BIGQUERY`, `BIGTABLE`, `CLOUDFUNCTIONS`, `CLOUDIOT`, `CLOUDSQL`, `CLOUDTASKS`, `COMPUTE`, `CONTAINER`,
               `DATAFLOW`, `DATAPROC`, `DATASTORE`, `FIREBASEDATABASE`, `FIREBASEHOSTING`, `FIRESTORE`, `INTERCONNECT`,
               `LOADBALANCING`, `LOGGING`, `ML`, `MONITORING`, `PUBSUB`, `REDIS`, `ROUTER`, `SERVICERUNTIME`, `SPANNER`, `STORAGE`,
               `TPU`, `VPN`
    ...
    @staticmethod
    def get(resource_name, id, opts=None, additional_tags=None, categories=None, force_save=None, json_key=None, metric_filter_regex=None, name=None, project_id=None, service=None, service_refresh_rate_in_minutes=None):
        """
