...
namespace Pulumi.Wavefront.Inputs
{
    ...
    public sealed class MetricsPolicyPolicyRuleArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("tags")]
        private InputList<Inputs.MetricsPolicyPolicyRuleTagArgs>? _tags;

        /// <summary>
        /// List of Key/Value tags to select target metrics for policy.
        /// </summary>
        public InputList<Inputs.MetricsPolicyPolicyRuleTagArgs> Tags
        {
            get => _tags ?? (_tags = new InputList<Inputs.MetricsPolicyPolicyRuleTagArgs>());
            set => _tags = value;
        }
        ...
        public MetricsPolicyPolicyRuleArgs()
        {
        }
        public static new MetricsPolicyPolicyRuleArgs Empty => new MetricsPolicyPolicyRuleArgs();
    }
}
