...
public final class AlertTargetState extends com.pulumi.resources.ResourceArgs {

    public static final AlertTargetState Empty = new AlertTargetState();
    ...
    private AlertTargetState() {}

    private AlertTargetState(AlertTargetState $) {
    ...
    public static Builder builder(AlertTargetState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AlertTargetState();
        }

        public Builder(AlertTargetState defaults) {
            $ = new AlertTargetState(Objects.requireNonNull(defaults));
        }
