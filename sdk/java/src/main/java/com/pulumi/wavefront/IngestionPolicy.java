...
public class IngestionPolicy extends com.pulumi.resources.CustomResource {
     ...
     */
    public IngestionPolicy(java.lang.String name) {
     ...
     */
    public IngestionPolicy(java.lang.String name, IngestionPolicyArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public IngestionPolicy(java.lang.String name, IngestionPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("wavefront:index/ingestionPolicy:IngestionPolicy", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private IngestionPolicy(java.lang.String name, Output<java.lang.String> id, @Nullable IngestionPolicyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("wavefront:index/ingestionPolicy:IngestionPolicy", name, state, makeResourceOptions(options, id), false);
    }

    private static IngestionPolicyArgs makeArgs(IngestionPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? IngestionPolicyArgs.Empty : args;
    }
     ...
     */
    public static IngestionPolicy get(java.lang.String name, Output<java.lang.String> id, @Nullable IngestionPolicyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
