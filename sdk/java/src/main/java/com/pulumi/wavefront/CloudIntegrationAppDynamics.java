...
public class CloudIntegrationAppDynamics extends com.pulumi.resources.CustomResource {
     ...
     */
    public CloudIntegrationAppDynamics(java.lang.String name) {
     ...
     */
    public CloudIntegrationAppDynamics(java.lang.String name, CloudIntegrationAppDynamicsArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public CloudIntegrationAppDynamics(java.lang.String name, CloudIntegrationAppDynamicsArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("wavefront:index/cloudIntegrationAppDynamics:CloudIntegrationAppDynamics", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private CloudIntegrationAppDynamics(java.lang.String name, Output<java.lang.String> id, @Nullable CloudIntegrationAppDynamicsState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("wavefront:index/cloudIntegrationAppDynamics:CloudIntegrationAppDynamics", name, state, makeResourceOptions(options, id), false);
    }

    private static CloudIntegrationAppDynamicsArgs makeArgs(CloudIntegrationAppDynamicsArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? CloudIntegrationAppDynamicsArgs.Empty : args;
    }
     ...
     */
    public static CloudIntegrationAppDynamics get(java.lang.String name, Output<java.lang.String> id, @Nullable CloudIntegrationAppDynamicsState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
