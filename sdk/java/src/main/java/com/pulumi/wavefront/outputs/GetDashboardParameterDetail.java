...
@CustomType
public final class GetDashboardParameterDetail {
    /**
    ...
    private GetDashboardParameterDetail() {}
    /**
     * @return The default value of the parameter.
     * 
     */
    ...
    public static Builder builder(GetDashboardParameterDetail defaults) {
    ...
    public static final class Builder {
        ...
        private Map<String,String> valuesToReadableStrings;
        public Builder() {}
        public Builder(GetDashboardParameterDetail defaults) {
        ...
        public Builder defaultValue(String defaultValue) {
            if (defaultValue == null) {
              throw new MissingRequiredPropertyException("GetDashboardParameterDetail", "defaultValue");
            }
        ...
        public Builder dynamicFieldType(String dynamicFieldType) {
            if (dynamicFieldType == null) {
              throw new MissingRequiredPropertyException("GetDashboardParameterDetail", "dynamicFieldType");
            }
        ...
        public Builder hideFromView(Boolean hideFromView) {
            if (hideFromView == null) {
              throw new MissingRequiredPropertyException("GetDashboardParameterDetail", "hideFromView");
            }
        ...
        public Builder label(String label) {
            if (label == null) {
              throw new MissingRequiredPropertyException("GetDashboardParameterDetail", "label");
            }
            this.label = label;
            return this;
        }
        ...
        public Builder parameterType(String parameterType) {
            if (parameterType == null) {
              throw new MissingRequiredPropertyException("GetDashboardParameterDetail", "parameterType");
            }
        ...
        public Builder queryValue(String queryValue) {
            if (queryValue == null) {
              throw new MissingRequiredPropertyException("GetDashboardParameterDetail", "queryValue");
            }
        ...
        public Builder tagKey(String tagKey) {
            if (tagKey == null) {
              throw new MissingRequiredPropertyException("GetDashboardParameterDetail", "tagKey");
            }
            this.tagKey = tagKey;
            return this;
        }
        ...
        public Builder valuesToReadableStrings(Map<String,String> valuesToReadableStrings) {
            if (valuesToReadableStrings == null) {
              throw new MissingRequiredPropertyException("GetDashboardParameterDetail", "valuesToReadableStrings");
            }
