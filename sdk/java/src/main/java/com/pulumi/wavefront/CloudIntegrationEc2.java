...
public class CloudIntegrationEc2 extends com.pulumi.resources.CustomResource {
     ...
     */
    public CloudIntegrationEc2(java.lang.String name) {
     ...
     */
    public CloudIntegrationEc2(java.lang.String name, CloudIntegrationEc2Args args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public CloudIntegrationEc2(java.lang.String name, CloudIntegrationEc2Args args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("wavefront:index/cloudIntegrationEc2:CloudIntegrationEc2", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private CloudIntegrationEc2(java.lang.String name, Output<java.lang.String> id, @Nullable CloudIntegrationEc2State state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("wavefront:index/cloudIntegrationEc2:CloudIntegrationEc2", name, state, makeResourceOptions(options, id), false);
    }

    private static CloudIntegrationEc2Args makeArgs(CloudIntegrationEc2Args args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? CloudIntegrationEc2Args.Empty : args;
    }
     ...
     */
    public static CloudIntegrationEc2 get(java.lang.String name, Output<java.lang.String> id, @Nullable CloudIntegrationEc2State state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
