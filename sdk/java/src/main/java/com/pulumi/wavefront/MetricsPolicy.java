...
public class MetricsPolicy extends com.pulumi.resources.CustomResource {
     ...
     */
    public MetricsPolicy(java.lang.String name) {
     ...
     */
    public MetricsPolicy(java.lang.String name, MetricsPolicyArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public MetricsPolicy(java.lang.String name, MetricsPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("wavefront:index/metricsPolicy:MetricsPolicy", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private MetricsPolicy(java.lang.String name, Output<java.lang.String> id, @Nullable MetricsPolicyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("wavefront:index/metricsPolicy:MetricsPolicy", name, state, makeResourceOptions(options, id), false);
    }

    private static MetricsPolicyArgs makeArgs(MetricsPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? MetricsPolicyArgs.Empty : args;
    }
     ...
     */
    public static MetricsPolicy get(java.lang.String name, Output<java.lang.String> id, @Nullable MetricsPolicyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
