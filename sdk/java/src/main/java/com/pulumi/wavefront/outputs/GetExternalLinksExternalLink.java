    ...
    public static final class Builder {
        ...
        public Builder createdEpochMillis(Integer createdEpochMillis) {
            if (createdEpochMillis == null) {
              throw new MissingRequiredPropertyException("GetExternalLinksExternalLink", "createdEpochMillis");
            }
        ...
        public Builder creatorId(String creatorId) {
            if (creatorId == null) {
              throw new MissingRequiredPropertyException("GetExternalLinksExternalLink", "creatorId");
            }
        ...
        public Builder description(String description) {
            if (description == null) {
              throw new MissingRequiredPropertyException("GetExternalLinksExternalLink", "description");
            }
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetExternalLinksExternalLink", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder isLogIntegration(Boolean isLogIntegration) {
            if (isLogIntegration == null) {
              throw new MissingRequiredPropertyException("GetExternalLinksExternalLink", "isLogIntegration");
            }
        ...
        public Builder metricFilterRegex(String metricFilterRegex) {
            if (metricFilterRegex == null) {
              throw new MissingRequiredPropertyException("GetExternalLinksExternalLink", "metricFilterRegex");
            }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetExternalLinksExternalLink", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder pointTagFilterRegexes(Map<String,String> pointTagFilterRegexes) {
            if (pointTagFilterRegexes == null) {
              throw new MissingRequiredPropertyException("GetExternalLinksExternalLink", "pointTagFilterRegexes");
            }
        ...
        public Builder sourceFilterRegex(String sourceFilterRegex) {
            if (sourceFilterRegex == null) {
              throw new MissingRequiredPropertyException("GetExternalLinksExternalLink", "sourceFilterRegex");
            }
        ...
        public Builder template(String template) {
            if (template == null) {
              throw new MissingRequiredPropertyException("GetExternalLinksExternalLink", "template");
            }
        ...
        public Builder updatedEpochMillis(Integer updatedEpochMillis) {
            if (updatedEpochMillis == null) {
              throw new MissingRequiredPropertyException("GetExternalLinksExternalLink", "updatedEpochMillis");
            }
        ...
        public Builder updaterId(String updaterId) {
            if (updaterId == null) {
              throw new MissingRequiredPropertyException("GetExternalLinksExternalLink", "updaterId");
            }
            this.updaterId = updaterId;
            return this;
        }
        public GetExternalLinksExternalLink build() {
            final var _resultValue = new GetExternalLinksExternalLink();
