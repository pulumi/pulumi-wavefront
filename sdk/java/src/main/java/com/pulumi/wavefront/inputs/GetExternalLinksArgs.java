...
public final class GetExternalLinksArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetExternalLinksArgs Empty = new GetExternalLinksArgs();
    ...
    private GetExternalLinksArgs() {}

    private GetExternalLinksArgs(GetExternalLinksArgs $) {
        this.limit = $.limit;
        this.offset = $.offset;
    }
    ...
    public static Builder builder(GetExternalLinksArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetExternalLinksArgs();
        }

        public Builder(GetExternalLinksArgs defaults) {
            $ = new GetExternalLinksArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetExternalLinksArgs build() {
            return $;
        }
    }
